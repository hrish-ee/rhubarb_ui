...
discharges = _NavLink(title="Discharges", path="/discharges", icon="carbon:hospital")
info = _NavLink(title="Info", path="/info", icon="carbon:info")
...
def create_side_nave_content() -> dmc.Stack:
    main_links = dmc.Stack(
        ...
        children=[
            ...
            create_main_nav_link(
                icon=discharges.icon,
                label=discharges.title,
                href=discharges.path,
            ),
        ],
    )
